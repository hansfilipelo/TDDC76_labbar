...
/*
 * evaluate()
 anropar  evaluate() pŒ šversta noden
 skickar med variabeltabellen som anvŠnds
 */
...
/*
 * get_postfix()
 anropar postfix pŒ šversta noden i uttrycket
 */
...
/*
 * swap(other)
 byter pekare mellan tvŒ uttryck
 */
